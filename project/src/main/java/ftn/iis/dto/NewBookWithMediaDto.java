...
public class NewBookWithMediaDto {
    private String isbn;
    ...
    public NewBookWithMediaDto() {}

    public NewBookWithMediaDto(String isbn, String naslov, String autor, String sinopsis, Long katId, Integer brojStranaEK, Integer trajanjeSekundeAK) {
        this.isbn = isbn;
        this.naslov = naslov;
        this.autor = autor;
